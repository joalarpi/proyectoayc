...
/* @var $searchModel app\models\TipodocumentosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = Yii::t('app', 'Tipodocumentos');
...
<div class="tipodocumentos-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-globe"></i>TRANSACCIONES TIPO DE DOCUMENTOS</h3>',
        'type'=>'success',
